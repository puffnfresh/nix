 ...
 */
void setupPTYMaster(AutoCloseFD & builderOut, UserLock * buildUser, bool grantOnNoBuildUser = false);
...
void setupBuiltinFetchurlContext(BuiltinBuilderContext & ctx, const BasicDerivation & drv);
...
[[noreturn]] void runBuiltinBuilder(
    BuiltinBuilderContext & ctx, const BasicDerivation & drv, const OutputPathMap & scratchOutputs, Store & store);
 ...
 * Does not return.
 */
[[noreturn]] void execBuilder(const BasicDerivation & drv, const StringMap & inputRewrites, const StringMap & env);
